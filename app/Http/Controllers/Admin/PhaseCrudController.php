...
use App\Http\Requests\PhaseRequest as StoreRequest;
use App\Http\Requests\PhaseRequest as UpdateRequest;

class PhaseCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        // ------ CRUD BUTTONS
        $this->crud->addButtonFromView('line', 'getRoundsFromFPB', 'getRoundsFromFPB', 'end');
